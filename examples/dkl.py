...
def HDMR_example():
    ...
    dkl_simulation = mods.DeepKernelLearningSimulation()
    dkl_algorithm = mods.Algorithm(
    ...
    dkl_simulation.add(dkl_algorithm)
    ...
    with ms.MoDS_Session() as session:
        ...
        wrapper.add(dkl_simulation, rel=cuba.relationship)
        wrapper.session.run()
